    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Admin Server</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="@if (Route::getCurrentRoute()->getName() == $dashboardRoute) active @endif">
              <a href="{{ route($dashboardRoute) }}" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a>
            </li>
            <li class="menu-header">Model</li>
            <li class="@if (Route::getCurrentRoute()->getName() == $userRoute) active @endif">
              <a href="{{ route($userRoute) }}" class="nav-link"><i class="fas fa-table"></i><span>User</span></a>
            </li>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a>Pemrograman Web Nanda Yunan & Muhammad Azhari</a>
        </div>
